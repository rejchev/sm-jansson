...
extern cell_t JsonObjectGetInt64(IPluginContext *pContext, const cell_t *params);
...
extern cell_t JsonObjectSetInt64(IPluginContext *pContext, const cell_t *params);
...
extern cell_t JsonObjectRemoveKey(IPluginContext *pContext, const cell_t *params);
...
extern cell_t JsonObjectSize(IPluginContext *pContext, const cell_t *params);
